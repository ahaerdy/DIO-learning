# Repositório de Estudos – Bootcamp TQI Fullstack Developer

<p align="center"> 
  <img src="https://img.shields.io/badge/status-em%20andamento-orange" /> 
  <img src="https://img.shields.io/badge/Bootcamp-TQI%20Fullstack%20Developer-blue" /> 
  <img src="https://img.shields.io/badge/HTML5-Markup-orange?logo=html5" /> 
  <img src="https://img.shields.io/badge/CSS3-Styles-blue?logo=css3" /> 
  <img src="https://img.shields.io/badge/JavaScript-ES6+-yellow?logo=javascript" /> 
  <img src="https://img.shields.io/badge/React-Frontend-blue?logo=react" /> 
  <img src="https://img.shields.io/badge/Java-Backend-red?logo=openjdk" /> 
  <img src="https://img.shields.io/badge/Spring-Framework-green?logo=spring" /> 
  <img src="https://img.shields.io/badge/QA-Quality%20Assurance-lightgrey?logo=testing-library" /> 
...
- Exercícios resolvidos relacionados aos fundamentos e práticas do desenvolvimento fullstack
- Notas e explicações sobre conceitos de front-end, back-end e boas práticas
...
- JavaScript (ES6+) e fundamentos de lógica de programação
...
- [x] Curso: ⭐️ [Trabalhando com States & Effects no ReactJs](Modulo_04/03-Curso.03-Trabalhando.com.States.and.Effects.no.ReactJs)
...
- [x] Curso: [Principais Protocolos de Comunicação da Internet](Modulo_07/01-Curso.01-Principais_Protocolos_de_Comunicacao_da_Internet)
- [x] Curso: [Introdução a Spring Framework com Spring Boot](Modulo_07/02-Curso.02-Introducao_a_Spring_Framework_com_Spring_Boot)
- [x] Desafio: [Design Patterns com Java: Dos Clássicos (GoF) ao Spring Framework](Modulo_07/03-Desafio-Design_Patterns_com_Java_Dos_Classicos_GoF_ao_Spring_Framework)
...
- [x] Desafio: [Desenvolvimento de Testes Unitários para Validar uma API REST de Gerenciamento Estoques de Cerveja](Modulo_07/05-Desafio-Desenvolvimento_de_Testes_Unitarios_para_Validar_uma_API_REST_de_Gerenciamento_Estoques_de_Cerveja) 
    - **Repositório**: [dio-beer-stock-api-testes-unitarios](https://github.com/ahaerdy/dio-beer-stock-api-testes-unitarios)
    - **Descrição**: O projeto consiste na implementação de uma **API REST para gerenciamento de cervejas**, desenvolvida utilizando **Java e Spring Boot**, como parte do desafio de projeto do curso da DIO. A aplicação permite realizar operações de cadastro, consulta, atualização e remoção de cervejas por meio de endpoints REST, seguindo os princípios de arquitetura em camadas. Durante o desenvolvimento foram aplicados conceitos importantes do ecossistema Spring, como **Spring Web, Spring Data JPA, validação de dados e testes automatizados**, além da organização do código em camadas de **controller, service, repository e model**. O objetivo do projeto foi consolidar conhecimentos sobre desenvolvimento de APIs com Spring Boot, boas práticas de estruturação de projetos e criação de testes para garantir a qualidade da aplicação.
...
- [x] Curso: [Introdução a Testes de Software](Modulo_08/03-Curso.03-Introducao_a_Testes_de_Software)
