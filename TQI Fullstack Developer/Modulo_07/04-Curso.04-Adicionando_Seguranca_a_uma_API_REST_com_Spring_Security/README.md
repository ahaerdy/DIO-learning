...
- Fork do repositorio do código deste curso: https://github.com/ahaerdy/fork-dio-springboot
...
O vídeo resume o processo de configuração, teste e validação de segurança em uma API Java, utilizando JSON Web Tokens (JWT) para autenticação e o banco de dados H2 para persistência em memória.

### Anotações

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h24m21s824.jpg" alt="" width="840">
</p>

Para finalizar a configuração do banco de dados em memória H2 Database, é necessário adicionar as propriedades básicas de conexão no arquivo `application.properties`. Essas configurações definem a plataforma, o driver e a URL de conexão para o banco em memória.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h24m29s081.jpg" alt="" width="840">
</p>

Além das configurações de conexão, definimos as credenciais de acesso ao banco (usuário e senha) e habilitamos a exibição dos logs de SQL no console. Isso permite visualizar todas as operações de banco de dados realizadas pela aplicação durante a execução.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h24m37s040.jpg" alt="" width="840">
</p>

Uma propriedade fundamental para os testes é a `spring.h2.console.enabled=true`. Ela determina para o Spring Boot que o console web do H2 estará disponível, permitindo o acesso visual ao banco de dados através do navegador.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h24m58s950.jpg" alt="" width="840">
</p>

Com as configurações concluídas, a aplicação é executada para validar se o ambiente de segurança e o banco de dados inicializam corretamente. O console exibe o log de inicialização do Spring Boot, indicando que a aplicação está subindo na porta padrão 8080.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h25m08s456.jpg" alt="" width="840">
</p>

Ao observar o log de inicialização, nota-se a interação do JPA com o H2. O Hibernate executa os comandos DDL para a criação automática da estrutura do banco baseada no mapeamento das entidades da aplicação.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h25m14s007.jpg" alt="" width="840">
</p>

O log detalha a criação das tabelas necessárias para gerenciar os usuários e suas respectivas permissões, como a tabela `tab_user` e a tabela de relacionamento `tab_user_roles`.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h25m43s959.jpg" alt="" width="840">
</p>

O acesso ao console do H2 é feito via browser através do endereço `localhost:8080/h2-console`. Na tela de login, utilizam-se as credenciais configuradas anteriormente no `application.properties` para conectar ao banco em memória e visualizar as tabelas criadas.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h28m26s982.jpg" alt="" width="840">
</p>

Para testar o cadastro de usuários, utiliza-se o Postman realizando uma requisição do tipo `POST` para o endpoint `/users`. Como a aplicação ainda não possui documentação Swagger, as requisições são montadas manualmente enviando um corpo em formato JSON.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h28m51s299.jpg" alt="" width="840">
</p>

No corpo da requisição JSON, definimos os dados do usuário a ser cadastrado, incluindo nome, username, password e uma lista de roles (papéis) que este usuário terá no sistema.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h28m59s300.jpg" alt="" width="840">
</p>

Ao executar a requisição, o log da aplicação confirma a inserção dos dados nas tabelas correspondentes através de comandos `insert` executados pelo Hibernate, resultando em um status HTTP 200 (OK).

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h29m39s291.jpg" alt="" width="840">
</p>

Voltando ao console do H2, é possível realizar um `SELECT` na tabela de usuários para confirmar que o registro foi persistido com sucesso. Nota-se que a senha já consta criptografada no banco, graças ao encoder configurado no projeto.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h30m07s760.jpg" alt="" width="840">
</p>

Com o usuário na base, inicia-se a implementação do recurso de login. O primeiro passo é criar uma classe `Login` (ou `LoginDTO`) que servirá para capturar as credenciais enviadas pelo cliente durante a tentativa de autenticação.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h30m15s741.jpg" alt="" width="840">
</p>

A classe `Login` possui apenas os atributos `username` e `password`, acompanhados de seus respectivos getters e setters. Estes parâmetros serão utilizados para validar o usuário e gerar o token JWT.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h31m09s102.jpg" alt="" width="840">
</p>

Em seguida, cria-se a classe `Sessao`, que representa o objeto de resposta após uma autenticação bem-sucedida. Ela é responsável por retornar ao cliente as informações necessárias para as requisições subsequentes.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h31m36s585.jpg" alt="" width="840">
</p>

A estrutura da `Sessao` contém o login do usuário e o token gerado. O token é acompanhado pelo prefixo configurado (como "Bearer ") para que o cliente possa enviá-lo diretamente no cabeçalho de autorização.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h31m51s543.jpg" alt="" width="840">
</p>

Esta imagem ilustra a estrutura final da classe responsável por conter o resultado da autenticação, pronta para ser serializada em JSON e enviada como resposta ao cliente que solicitou o login.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h33m06s436.jpg" alt="" width="840">
</p>

Cria-se o `LoginController` para gerenciar as requisições de autenticação. Ele injeta as dependências necessárias, como o repositório de usuários e o encoder de senhas, para processar a lógica de validação.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h33m23s758.jpg" alt="" width="840">
</p>

O algoritmo de login localiza o usuário pelo username. Em seguida, utiliza o `passwordEncoder` para comparar a senha vinda da requisição com a senha criptografada armazenada no banco de dados.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h33m56s563.jpg" alt="" width="840">
</p>

Se a autenticação for bem-sucedida, o controlador cria um objeto JWT, preenche os dados necessários (como as permissões/roles) e utiliza um gerador de token para produzir a string JWT que será retornada no objeto `Sessao`.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h34m11s783.jpg" alt="" width="840">
</p>

Neste ponto, a aplicação possui dois controladores principais: o `UserController` para gestão de usuários e o `LoginController` para autenticação e geração de tokens, permitindo o fluxo completo de acesso seguro.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h35m51s353.jpg" alt="" width="840">
</p>

Ao testar o login no Postman enviando um campo com nome errado (ex: "passord" em vez de "password"), a aplicação retorna um erro de servidor (Internal Server Error 500). Isso ocorre porque o objeto de login não foi populado corretamente para a validação.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h43m05s779.jpg" alt="" width="840">
</p>

Corrigindo os parâmetros no Postman, o login é realizado com sucesso. A resposta contém o username do usuário e o token JWT gerado, precedido pelo prefixo `Bearer`. Esse token deve ser armazenado pelo cliente para as próximas requisições.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h43m16s111.jpg" alt="" width="840">
</p>

Para validar a composição do token, utiliza-se o site `jwt.io`. Ao colar o token no debugger, é possível visualizar o payload decodificado, confirmando informações como data de criação, expiração e as authorities (roles) atribuídas ao usuário.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h44m04s996.jpg" alt="" width="840">
</p>

Cria-se um `WelcomeController` com diferentes rotas para testar a aplicabilidade das permissões. Existem rotas genéricas, rotas exclusivas para usuários autenticados e rotas restritas apenas para o perfil de gerentes (managers).
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h44m47s324.jpg" alt="" width="840">
</p>

As permissões são mapeadas na classe `WebSecurityConfig`. Aqui define-se quais rotas são públicas e quais exigem roles específicas, como as rotas de usuários e administradores, utilizando o método `hasAnyRole`.
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h46m08s377.jpg" alt="" width="840">
</p>

Ao tentar acessar a rota `/users` sem enviar o token, a aplicação retorna o status 403 Forbidden. Isso demonstra que o filtro de segurança está interceptando a requisição e negando o acesso por falta de credenciais válidas.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h46m41s168.jpg" alt="" width="840">
</p>

Para obter acesso, é necessário incluir no cabeçalho da requisição o campo `Authorization`, colando o valor do token obtido no login. Com o token presente, o Spring Security valida a assinatura e as permissões contidas no payload.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-03-04-10h47m13s052.jpg" alt="" width="840">
</p>
