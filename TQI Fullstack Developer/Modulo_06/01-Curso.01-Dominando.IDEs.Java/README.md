...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-18-11h36m15s323.jpg" alt="" width="840">
</p>
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-18-11h36m18s814.jpg" alt="" width="840">
</p>
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-18-11h36m23s591.jpg" alt="" width="840">
</p>
...
<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-18-11h36m36s501.jpg" alt="" width="840">
</p>
...
<p align="center"> <img src="000-Midia_e_Anexos/vlcsnap-2026-01-18-14h11m20s701.jpg" alt="" width="840"> </p>
...
link do vídeo: https://web.dio.me/track/tqi-fullstack-developer/course/dominando-ides-java/learning/0c9c5a4b-b1e8-4fbd-8e24-cf8f8275dece?autoplay=1
...
Esta aula técnica aborda o processo de depuração (debug) no ambiente de desenvolvimento IntelliJ IDEA, utilizando como exemplo prático a criação de uma calculadora em Java. O conteúdo foca na transição de usuários do Eclipse para o IntelliJ, destacando as diferenças de atalhos, a identificação de erros de lógica em operações aritméticas e a configuração da estrutura do projeto (SDK/JDK).
...
Ao criar uma nova classe, como a `Calculadora.java`, o IntelliJ IDEA sugere a inclusão do arquivo no sistema de controle de versão Git através de uma janela de diálogo. Essa funcionalidade permite que o desenvolvedor rastreie as alterações no novo arquivo desde o momento de sua criação.

<p align="center">
<img src="000-Midia_e_Anexos/visnap-2026-01-19-18h18m05s235.jpg" alt="" width="840">
</p>

Nesta etapa, o ambiente de desenvolvimento sinaliza um erro de compilação na classe `Calculadora`. O IntelliJ identifica que o método `subtrair(int, int)` está duplicado, o que é proibido em Java, impedindo a execução do programa até que a redundância seja corrigida.
...
<p align="center">
<img src="000-Midia_e_Anexos/viesnap-2026-01-19-18h18m08s351.jpg" alt="" width="840">
</p>

A classe `Calculadora` agora conta com os métodos para as quatro operações aritméticas básicas: soma, subtração, multiplicação e divisão. Note que a IDE exibe um aviso visual no método `dividir`, indicando que ele ainda não foi utilizado em nenhuma parte do código.
...
<p align="center">
<img src="000-Midia_e_Anexos/vissnap-2026-01-19-18h18m13s110.jpg" alt="" width="840">
</p>

Para permitir a interação com o usuário, é importada a classe `Scanner` do pacote `java.util`. No método `main`, uma nova instância do `Scanner` é criada, vinculada à entrada padrão do sistema (`System.in`), preparando o programa para receber dados via teclado.
...
<p align="center">
<img src="000-Midia_e_Anexos/visenap-2026-01-19-18h18m23s640.jpg" alt="" width="840">
</p>

O programa solicita ao usuário o primeiro valor através de uma mensagem no console. A variável `a`, declarada como um inteiro, recebe o valor digitado por meio do método `scan.nextInt()`.
...
<p align="center">
<img src="000-Midia_e_Anexos/visnap-2026-01-19-18h18m34s171.jpg" alt="" width="840">
</p>

Dando continuidade ao fluxo de entrada, o sistema solicita o segundo valor numérico. Este valor é capturado e armazenado na variável `b`, finalizando a coleta dos operandos necessários para realizar os cálculos da calculadora.
...
<p align="center">
<img src="000-Midia_e_Anexos/visnap-2026-01-19-18h19m00s937.jpg" alt="" width="840">
</p>

Com os valores de `a` e `b` disponíveis, o programa chama os métodos estáticos da classe para processar as operações. Os resultados de cada operação são armazenados em variáveis específicas e impressos no console logo em seguida, acompanhados de uma etiqueta identificadora.
...
<p align="center">
<img src="000-Midia_e_Anexos/visnap-2026-01-19-18h30m05s831.jpg" alt="" width="840">
</p>

A imagem ilustra a execução final da `Calculadora` no terminal integrado do IntelliJ. Após o processamento das entradas, o console exibe os resultados das operações, como a multiplicação resultando em 10 e a divisão resultando em 2, indicando que o programa funcionou conforme o esperado.

<p align="center">
<img src="000-Midia_e_Anexos/vissnap-2026-01-19-18h31m24s873.jpg" alt="" width="840">
</p>

O IntelliJ IDEA oferece diversas ferramentas de produtividade, como o menu de ações de contexto acessado pelo atalho `Alt+Enter`. Esse recurso permite visualizar sugestões de refatoração, correções rápidas de erros e melhorias estruturais diretamente no ponto do código onde o cursor está posicionado.      
