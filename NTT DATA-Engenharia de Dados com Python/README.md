...
- [ ] Curso: [Limpeza e Transformação de Dados com Power BI](Modulo_07/02-Curso.02-Limpeza_e_Transformacao_de_Dados_com_Power_BI)
- [ ] Desafio: [Criando um Dashboard corporativo com integração com MySQL e Azure](Modulo_07/03-Curso.03-Criando_um_Dashboard_corporativo_com_integracao_com_MySQL_e_Azure)
