...
- [x] Projeto: [Modelando um Dashboard de E-commerce com Power BI Utilizando Fórmulas DAX](Modulo_08/06-Desafio-Modelando_um_Dashboard_de_E-commerce_com_Power_BI_Utilizando_Formulas_DAX)
  ...
  > 📌 **Nota sobre o escopo:**  embora este desafio de projeto seja originalmente intitulado pela DIO como "Modelando um Dashboard de E-commerce", a análise exploratória dos dados revelou que o conjunto de dados (`Financial_Sample.xlsx`) reflete, na verdade, um cenário de Vendas Corporativas (B2B) e Governamentais (B2G) de uma cadeia de suprimentos global.
