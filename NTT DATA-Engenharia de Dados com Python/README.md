...
- [x] Projeto: [Dashboard de Vendas com Power BI utilizando Star Schema](Modulo_08/05-Desafio-Dashboard_de_Vendas_com_Power_BI_utilizando_Star_Schema)
  ...
  > 📌 **Nota sobre o escopo do projeto:**  Embora o desafio original na plataforma da DIO receba o título oficial de *"Dashboard de Vendas com Power BI utilizando Star Schema"*, os requisitos e o banco de dados fornecidos no desafio tratam de um cenário acadêmico (extraído de outro Bootcamp).
