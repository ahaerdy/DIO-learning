...
- Python (fundamentos e aplicações para dados)
- SQL e manipulação de dados
- Power BI (fundamentos, relatórios e dashboards)
-  Tratamento e transformação de dados (ETL)
-  Git e GitHub
-  Versionamento e colaboração
-  Projetos reais com dados e visualização
...
- [x] Projeto: [Criando um Sistema Bancário com Python](Modulo_02/05-Projeto-Criando_um_Sistema_Bancario_com_Python)
  - **Repositório**: [desafio.py](https://github.com/ahaerdy/DIO-learning/blob/main/Suzano%20-%20Python%20Developer/Modulo_02/05-Projeto-Criando_um_Sistema_Bancario_com_Python/Projeto/desafio.py)
...
- [x] Desafio: [Aplicando Técnicas de Listas em Python](Modulo_03/08-Desafio-Aplicando.Tecnicas.de.Listas.em.Python)
...
- [x] Projeto: [Dashboard de Vendas com Power BI utilizando Star Schema](Modulo_08/05-Desafio-Dashboard_de_Vendas_com_Power_BI_utilizando_Star_Schema)
  ...
  > 📌 **Nota sobre o escopo:**  embora o título oficial do projeto seja *"Dashboard de Vendas com Power BI utilizando Star Schema"*, os requisitos e o banco de dados fornecidos tratam da análise de indicadores de professores e disciplinas em um ambiente universitário.
- [x] Projeto: [Modelando um Dashboard de E-commerce com Power BI Utilizando Fórmulas DAX](Modulo_08/06-Desafio-Modelando_um_Dashboard_de_E-commerce_com_Power_BI_Utilizando_Formulas_DAX)
  ...
  - **Descrição**: o objetivo deste projeto é transformar uma tabela plana única — a **Financial Sample** — em um modelo de dados relacional otimizado no formato **Star Schema (Esquema Estrela)**, utilizando Power Query para as transformações e DAX para a criação da tabela de calendário.
...
- [x] Curso: [Relatórios & Experiência do Usuário no Power BI](Modulo_09/01-Curso.01-Relatorios_e_Experiencia_do_Usuario_no_Power_BI)
- [X] Curso: [Explorando Recursos para criar Storytelling dos dados com Power BI
- [X] Curso: Fundamentos de Data Analytics com Power BI](Modulo_09/02-Curso.02-Explorando_Recursos_para_criar_Storytelling_dos_dados_com_Power_BI)
...
Este repositório continuará sendo atualizado à medida que novos projetos, insights e materiais forem adicionados.
