...
## Parte 1 - Primeiros Passos com Power BI
...
O vídeo aborda a relevância do Power BI no cenário atual de análise de dados, destacando que decisões assertivas dependem de informações de alta qualidade e não apenas de intuição. O autor enfatiza que a maior parte do trabalho de um especialista consiste na coleta e limpeza de dados, visto que bases perfeitas são raras na prática. A ferramenta é apresentada como líder de mercado, oferecendo independência aos profissionais de negócios e reduzindo a sobrecarga das equipes de TI. Além disso, a fonte menciona a integração com o ecossistema Microsoft e a facilidade de compartilhamento de relatórios como grandes diferenciais competitivos. Por fim, o material introduz a parte prática de uma formação, orientando sobre a instalação do software e a exploração de suas funcionalidades.

### Anotações

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-20-15h42m26s767.jpg" alt="" width="840">
</p>

A análise de dados eficiente permite **tomar decisões com confiança**, distanciando o processo de escolhas baseadas apenas no "feeling" ou intuição. Para que esse embasamento seja real, é fundamental que a **base de dados seja de alta qualidade**. Não basta utilizar ferramentas avançadas como o Power BI para criar dashboards visualmente impactantes se os dados de origem forem incoerentes ou infundados, pois isso resultaria em conhecimentos equivocados. No cenário real, os dados raramente estão prontos; o profissional deve identificar lacunas e investir a maior parte de seu tempo nos processos de **coleta e limpeza de dados**.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-20-15h42m31s886.jpg" alt="" width="840">
</p>

O ecossistema da Microsoft oferece uma série de ferramentas integradas que potencializam o uso do Power BI:

* **Power BI**: Utilizado para a criação e compartilhamento de dashboards, permitindo a publicação e o envio de relatórios (recursos que podem envolver custos de licenciamento acessíveis para empresas e profissionais).
* **Power Automate**: Focado na automação de processos e tomadas de decisão.
* **Power Apps**: Permite a criação de aplicativos através do conceito de *Low Code* (arrasta e larga), facilitando a persistência de informações integradas aos dados.
* **Power Gateway**: Software essencial para realizar a comunicação e publicação de dados quando se trabalha com dashboards online.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-20-15h42m34s198.jpg" alt="" width="840">
</p>

O Power BI promove uma **cultura controlada por dados para todos** através do conceito de *self-service software*. Isso significa que profissionais de diferentes áreas, não apenas do setor de TI, ganham independência para analisar suas próprias informações. Essa descentralização é benéfica para a organização, pois libera a equipe técnica de TI para demandas mais complexas, enquanto os analistas de negócio conseguem obter *insights* de última hora de forma ágil e autônoma.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-20-15h42m36s682.jpg" alt="" width="840">
</p>

O posicionamento de mercado do Power BI é validado pelo **Quadrante Mágico da Gartner (março de 2022)** para plataformas de Analytics e Business Intelligence. No gráfico, a **Microsoft aparece como líder isolada**, posicionada no quadrante superior direito (Leaders), seguida por Tableau e Qlik. Estar no topo deste quadrante reflete tanto a "Habilidade de Execução" quanto a "Plenitude de Visão" da ferramenta, justificando o foco no aprendizado desta plataforma para fundamentação em análise de dados.
