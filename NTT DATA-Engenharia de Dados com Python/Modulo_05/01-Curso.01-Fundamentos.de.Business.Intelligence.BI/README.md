...
## Parte 1 - Apresentação da Formação
...
link do vídeo: https://web.dio.me/track/engenharia-dados-python/course/fundamentos-de-business-intelligence-bi/learning/79f64dff-3ad3-45f5-88bc-04d059a5d868?autoplay=1

A formação Power BI Analyst, apresentada por Juliana Mascarenhas, propõe uma jornada de aprendizado com abordagem "top-down", iniciando pela visualização de dados para depois aprofundar-se em coleta, transformação e modelagem. O curso é focado na prática, com diversos projetos e desafios, sendo estrategicamente alinhado aos requisitos da certificação Microsoft PL-300, tornando-o ideal para profissionais que buscam transformar dados em decisões estratégicas através de dashboards interativos.

### Anotações

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-16-18h55m34s736.jpg" alt="" width="840">
</p>

Esta formação é conduzida por **Juliana Mascarenhas**, Mestre em Modelagem Computacional, Cientista de Dados e especialista na DIO. A proposta é apresentar o ecossistema do **Power BI Analyst**, preparando o aluno para lidar com as demandas reais da área de dados através de uma trilha estruturada de aprendizado.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-16-18h55m47s750.jpg" alt="" width="840">
</p>

A formação utiliza uma **abordagem Top-Down**, permitindo que o aluno visualize o objetivo final logo no início. O fluxo de aprendizado percorre os pilares essenciais de **Visualização, Análise, Coleta e Transformação**. Além disso, o curso integra fundamentos da área de dados e a execução de projetos práticos desde o primeiro módulo para garantir a aplicação imediata dos conceitos.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-16-18h55m55s091.jpg" alt="" width="840">
</p>

No que tange à profundidade técnica, o curso foca intensamente na **Visualização de Dados com Power BI**, priorizando a criação de relatórios e dashboards profissionais. Há uma ênfase especial na integração com bancos de dados e na introdução aos fundamentos de **Modelagem Dimensional**, essenciais para estruturar projetos de BI robustos.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-16-18h55m57s038.jpg" alt="" width="840">
</p>

Os primeiros passos práticos envolvem o domínio da linguagem **DAX**, fundamental para cálculos avançados no Power BI. Complementarmente, a formação explora a **Experiência do Usuário (UX)** no design de interfaces, técnicas de **Data Analytics** e a parte administrativa de gerenciamento de **workspaces e datasets** dentro do serviço do Power BI.

<p align="center">
<img src="000-Midia_e_Anexos/vlcsnap-2026-01-16-18h56m02s752.jpg" alt="" width="840">
</p>

Esta formação é destinada a profissionais que precisam comunicar resultados visualmente, como analistas de dados, cientistas de dados e analistas de BI. A estrutura conta com **8 desafios de projeto** e aborda temas fundamentais alinhados ao exame de certificação **PL-300 da Microsoft**, servindo como uma base sólida para quem busca essa titulação oficial.      
