...
1. O **README** do curso "**Consumindo APIs Externas com a Spring Cloud OpenFeign**", onde documento anotações detalhadas de cada vídeo (screenshots dos slides, trechos de código exibidos em aula, e explicações do que foi ensinado).
