...
*   **Reuso de Código:** Evita a duplicidade ao permitir que classes específicas (como `Gerente` ou `Vendedor`) aproveitem campos comuns definidos em uma classe base (`Colaborador`), como nome, idade e endereço 
