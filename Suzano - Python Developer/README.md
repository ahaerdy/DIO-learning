...
- [x] Curso: [Introdução ao Python com a Suzano](Modulo_01/01-Curso%201-Introdução%20ao%20Python%20com%20Suzano/)
- [x] Curso: [Ambiente de Desenvolvimento e Primeiros Passos com Python](https://github.com/ahaerdy/DIO-learning/tree/main/Suzano%20-%20Python%20Developer/Modulo_02/02-Curso_2-Estruturas.Condicionais.e.de.Repeticao.em.Python)
...
- [x] Curso: [Estruturas Condicionais e de Repetição em Python](Modulo_02/02-Curso_2-Estruturas.Condicionais.e.de.Repeticao.em.Python)
...
- [x] Projeto: [Criando um Sistema Bancário com Python](Modulo_02/05-Projeto-Criando_um_Sistema_Bancario_com_Python#descri%C3%A7%C3%A3o)
  - **Repositório**: [dio-sistema-bancario-python](https://github.com/ahaerdy/dio-sistema-bancario-python)
...
- [x] Curso: [Trabalhando com Listas em Python](https://github.com/ahaerdy/DIO-learning/tree/main/Suzano%20-%20Python%20Developer/Modulo_03/01-Curso%2001-Trabalhando_com_Listas_em_Python#parte-1---trabalhando-com-listas-em-python)
...
- [x] Curso: [Desafios de Código: Aperfeiçoe Sua Lógica e Pensamento Computacional](https://github.com/ahaerdy/DIO-learning/tree/main/Suzano%20-%20Python%20Developer/Modulo_03/07-Curso%2007-Desafios_de_C%C3%B3digo_Aperfei%C3%A7oe_Sua_L%C3%B3gica_e_Pensamento_Computacional#parte-1---desafios-de-c%C3%B3digo---aperfei%C3%A7oe-sua-l%C3%B3gica-e-pensamento-computacional)
- [x] Desafio: [Desafio: Gestão e Controle de Transações Bancárias](https://github.com/ahaerdy/DIO-learning/tree/main/Suzano%20-%20Python%20Developer/Modulo_03/08-Curso%2008-Desafio_Gest%C3%A3o_e_Control_de_Transa%C3%A7%C3%B5es_Bancarias#desafio-1---registro-de-transa%C3%A7%C3%B5es-banc%C3%A1rias)
...
- [x] Curso: [Ramificando um Tópico no Microsoft Copilot Studio](https://github.com/ahaerdy/DIO-learning/tree/main/Suzano%20-%20Python%20Developer/Modulo_05/05-Curso_5-Ramificando_um_Topico_no_Microsoft_Copilot_Studio#-v%C3%ADdeo-01---introdu%C3%A7%C3%A3o)
...
- [x] Desafio: [Criando um Copiloto com Fluxo de Conversa Personalizado no Microsoft Copilot Studio](https://github.com/ahaerdy/DIO-learning/tree/main/Suzano%20-%20Python%20Developer/Modulo_05/11-Curso_11-Criando_um_Copiloto_com_Fluxo_de_Conversa_Personalizado_no_Microsoft_Copilot_Studio#-v%C3%ADdeo-01---apresenta%C3%A7%C3%A3o-do-desafio)
  ...
  - Repositório: [DIO-criando-um-copiloto-com-fluxo-de-conversa-personalizado-no-microsoft-copilot-studio](https://github.com/ahaerdy/DIO-criando-um-copilo-com-fluxo-de-conversa-personalizado-no-microsoft-copilot-studio#)
...
- [x] Curso: [Conceitos de Processamento de Linguagem Natural](https://github.com/ahaerdy/DIO-learning/tree/main/Suzano%20-%20Python%20Developer/Modulo_06/04-Curso%204-Conceitos_de_Processamento_de_Linguagem_Natural#-v%C3%ADdeo-01---conceitos-de-processamento-de-linguagem-natural)
