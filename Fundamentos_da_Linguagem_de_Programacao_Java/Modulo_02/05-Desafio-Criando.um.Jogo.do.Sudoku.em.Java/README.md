...
Para não precisar digitar manualmente os argumentos toda vez que o programa rodar, é aberta a tela **Run/Debug Configurations** do IntelliJ, no campo destina      
